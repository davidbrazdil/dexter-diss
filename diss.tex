...
\subsection{Generation of IR}

The process of turning the input APK file into intermediate representation is mostly trivial. It is the vast number of DEX elements that need to be converted which makes it a tedious task. 
