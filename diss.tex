...
\centerbox{
	...
	\asmOrig{iget-obj rResult, rObject, \#fieldID} \\
	\asm{taint-set tObject, rResult}
}

internal-int
\centerbox{
	\asm{taint-get tObject, rObject} \\
	\asm{iget-int tResult, rObject, \#taintField(fieldID)} \\
	\asm{or-int tResult, tResult, tObject} \\
	\asmOrig{iget-int rResult, rObject, \#fieldID}
}

external-int
\centerbox{
	\asm{taint-get tResult, rObject} \\
	\asmOrig{iget-int rResult, rObject, \#fieldID}
}
...
\centerbox{
	\asm{taint-get tArray, rArray} \\
	\asmOrig{aget-int rResult, rArray, rIndex} \\
	\asm{or-int tResult, tArray, tIndex}
}
...
\centerbox{
	...
	\asm{or-int pExceptionTaint, tOpA, tOpB} \\
	\asm{taint-set pExceptionTaint, pException} \\
	\asm{LABEL\_XYZ:}
}
