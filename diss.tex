...
The official Dalvik compiler implements many advanced optimization techniques. Even though it was designed to convert JVM bytecode to DEX, further efforts could be made towards utilizing parts of its pipeline to generate more efficient code.
