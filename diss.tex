...
However, both of these policies fail to protect the user against applications that have a legitimate initial reason to read their private data but secretely leak them at the same time, since once access is granted the applications are free to use the resource in any way they want.
