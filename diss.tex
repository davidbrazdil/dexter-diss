...
Not foreseeing the complexity of this problem unfortunately led to the necessity to build a nearly full-fledged compiler, which in itself is a very challenging task difficult to achieve within the given time frame of the project. The convertor therefore aims to find any valid solution, regardless of its time efficiency or the performance of the generated code. 

The algorithms used here are mostly taken from the \emph{Modern Compiler Implementation in Java} textbook, and hence their implementation details will be ommited, except their Dalvik-specific modifications.
