...
\subsection{Basic Intra-Procedural Taint Propagation}
...
% They will also use the \verb$taint-get$ and \verb$taint-set$ pseudo-instructions (explained in section ~\ref{section:Code_Pseudoinstructions}) as a shorthand for calling the \verb$get$ and \verb$set$ methods of the taint-storing hash map for objects. Their arguments are:
% \centerbox{
