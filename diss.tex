...
\begin{inparaenum}[(i)]
\item set of all interfaces implemented by the class,
\item set of all defined methods,
\item set of all defined fields,
\item access flags and annotations of the class and all its methods and fields.
\end{inparaenum}
