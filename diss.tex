...
However, both of these policies fail to protect against applications that have a legitimate initial reason to read private data but secretely leak them at the same time, since once access is granted the applications are free to use the resource in any way they want.
