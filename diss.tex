...
Clash Graph is built by comparing the liveness intervals of individual variables, which can be established by performing so-called \emph{Live Variable Analysis} on the \emph{Control Flow Graph} of the method code. 
