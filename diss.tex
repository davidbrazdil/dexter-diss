...
This project was a success. It met all the success criteria, and demonstrated that dynamic taint-based data flow analysis can be applied on individual Android applications without having to modify the operating system. 

Dexter represents an easily extensible framework for precise tracking of data throughout instrumented applications. 
...
In its current state, Dexter is nearly ready for deployment. With the implementation of SSA finished, it would be capable of instrumenting any available application. Future development could focus on:
\begin{description}
