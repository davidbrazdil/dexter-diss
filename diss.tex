...
By using markers inside of the code, absolute addresses or relative offsets of these points can be determined at the assembly stage, and inserting extra instructions into the code or using different-sized variants of instructions does not break any links.
