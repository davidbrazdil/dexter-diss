...
\subsection{GoneSixty}
Analysis in appendix~\ref{chapter:Report_Gone60}.
...
I/System.out(10912): $! tainted Apache HTTPClient request executed => T=23
	\end{verbatim}
	\caption{Log output generated by the instrumented version of Gone60.}
\end{figure}
...
\begin{figure}
	\centerline{	
		\includegraphics[width=0.6\textwidth]{figs/fig_eval_testappbench.eps}
	}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.6\textwidth]{figs/fig_eval_quickbench.eps}
	}
