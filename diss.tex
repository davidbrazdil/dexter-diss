...
At the same time, pseudoinstructions can simplify some of the instrumentation rules, because they can be used as small inline functions. A simple example of this is the \verb$taint-get$ pseudoinstruction which was already introduced in section~\ref{section:TaintTagStorage_Objects}. It expands to:
	\begin{figure}[H]
		\centerbox{
	...
	\end{figure}
Similar expanding instructions were created for commonly used operations like printing debug information into the system log.
