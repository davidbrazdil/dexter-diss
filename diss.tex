...
Sometimes applications by mistake request access to more resources than they need. A cautious user might want to do preventive monitoring. 
\end{description}
...
Nevertheless, both of these policies fail to protect against applications that have a legitimate initial reason to read private data but secretly leak them too, since once granted the access to a resource is completely unrestricted.
